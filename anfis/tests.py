...
for dictrict in dictrictArr:
    ...
    mf = [[['gaussmf',{'mean':np.mean(X[0]),'sigma':np.std(X[0])}]
    ,['gaussmf',{'mean':np.mean(X[1]),'sigma':np.std(X[1])}]
    ,['gaussmf',{'mean':np.mean(X[2]),'sigma':np.std(X[2])}]
    ,['gaussmf',{'mean':np.mean(X[3]),'sigma':np.std(X[3])}]],
    [['gaussmf',{'mean':np.mean(X[0]),'sigma':np.std(X[0])}]
    ,['gaussmf',{'mean':np.mean(X[1]),'sigma':np.std(X[1])}]
    ,['gaussmf',{'mean':np.mean(X[2]),'sigma':np.std(X[2])}]
    ,['gaussmf',{'mean':np.mean(X[3]),'sigma':np.std(X[3])}]],
    [['gaussmf',{'mean':np.mean(X[0]),'sigma':np.std(X[0])}],['gaussmf',{'mean':np.mean(X[1]),'sigma':np.std(X[1])}]],
    [['gaussmf',{'mean':np.mean(X[1]),'sigma':np.mean(X[2])}],['gaussmf',{'mean':np.mean(X[2]),'sigma':np.mean(X[2])}]]
    ]
