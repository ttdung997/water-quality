...
dataCol = ['PO4-P(㎎/L)',
 'T-N(㎎/L)','T-P(㎎/L)', 'Dissolved Total N(㎎/L)','Dissolved Total P(㎎/L)',
  'Hydrogen ion conc.','DO (㎎/L)','Temp.(℃)','TSI(Chl-a)']
...
MasterDataframe = pd.read_excel('predata.xls',0)
...
for a in (0,2):
	...
	# X_temp = dataCol
	# print(dictrict)
	X = myDf[['Dissolved Total N(㎎/L)','Dissolved Total P(㎎/L)',
	  'Hydrogen ion conc.','DO (㎎/L)','Temp.(℃)']].values
