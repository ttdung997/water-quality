...
dataCol = ['PO4-P(㎎/L)',
 'T-N(㎎/L)','T-P(㎎/L)', 'Dissolved Total N(㎎/L)','Dissolved Total P(㎎/L)',
  'Hydrogen ion conc.','DO (㎎/L)','Temp.(℃)','Flowrate(m/s)','RainFall' 'TSI(Chl-a)']
...
for dictrict in dictrictArr:
	dataCol = ['Dissolved Total N(㎎/L)','Dissolved Total P(㎎/L)',
	  'Hydrogen ion conc.','DO (㎎/L)','Temp.(℃)','Flowrate(m/s)','RainFall']



	# X_temp = dataCol
	# print(dictrict)
	X = myDf[dataCol].values
	y = myDf['TSI(Chl-a)'].values
